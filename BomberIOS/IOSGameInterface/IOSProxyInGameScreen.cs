	...
	public class IOSProxyInGameScreen:ProxyInGameScreen
	{
		...
		public IOSProxyInGameScreen()
		{
			...
			_buttons = new Button[]
			{
				...
				buttonFactory.CreateMoveRightButton(0.15f * GameData.WindowWidth, 0.8f * GameData.WindowHeight),
				buttonFactory.CreateMoveUpButton(0.08f * GameData.WindowWidth, 0.7f * GameData.WindowHeight),
				buttonFactory.CreateMoveDownButton(0.08f * GameData.WindowWidth, 0.9f * GameData.WindowHeight),
